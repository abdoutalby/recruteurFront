...
import {getRecruter , updateRecruter} from "../features/recruter/recruterSlice"
function Profile() {
  ...
  useEffect(() => {
    ...
    dispatch(getRecruter(user._id)).unwrap().then(res => console.log(res , 'recruters state '))
  }, [user, dispatch]);
  ...
  }, [recruters,user, isError, isSuccess, message, navigate, dispatch]);
  ...
  const onSubmit = (e) => {
    ...
    dispatch(updateRecruter(userData))
      .unwrap()
      .then((data) => {
        toast.success("done");
        navigate('/profile')
                ...
                <div className='side-bar'>
                  <div className='user-info'>
                    ...
                    <ul className='meta list list-unstyled'>
                      <li className='name'>{recruters.name}</li>
                      <li>{recruters.tel} </li>
                      <li className='activity'>{recruters.adress}</li>
                    </ul>
                  </div>
                </div>
